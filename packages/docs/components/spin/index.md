...
<template>
  <c-spin :spinning="loading">
    <div
      style="padding: 16px; background: var(--ccui-color-bg-container); border: 1px solid var(--ccui-color-border-secondary); border-radius: 6px"
    >
...
<template>
  ...
  <c-spin :spinning="loading" tip="正在拉取最新数据…">
    <ul
      style="margin: 0; padding: 0 0 0 20px; background: var(--ccui-color-bg-container); border: 1px solid var(--ccui-color-border-secondary); border-radius: 6px"
    >
