...
<template>
  ...
  <c-flex
    ...
    align="center"
    gap="small"
    style="background: var(--ccui-area); padding: 8px; border-radius: 6px"
  >
    <c-tag>居中</c-tag>
...
<template>
  <c-flex gap="middle" style="background: var(--ccui-area); padding: 8px; border-radius: 6px">
    ...
    <c-flex
      ...
      justify="center"
      align="center"
      style="background: var(--ccui-color-bg-container); border-radius: 4px; padding: 8px"
    >
      撑开剩余空间
    </c-flex>
  ...
  <c-flex vertical :gap="12">
    <div v-for="a in aligns" :key="a">
      ...
      <c-flex
        :align="a"
        gap="small"
        style="background: var(--ccui-area); padding: 8px; border-radius: 6px; height: 80px"
      >
  ...
  <c-flex vertical style="background: var(--ccui-area); border-radius: 6px; height: 240px; overflow: hidden">
    ...
    <c-flex flex="1" style="overflow: hidden">
      ...
      <c-flex
        ...
        justify="center"
        align="center"
        style="padding: 16px; background: var(--ccui-color-bg-container)"
      >
