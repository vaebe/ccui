...
| 事件名 | 回调签名                                | 触发时机                   |
| ------ | --------------------------------------- | -------------------------- |
| change | `(activeHref: string)`                  | 滚动或点击使当前锚点变化时 |
