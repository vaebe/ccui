...
<template>
  <c-watermark :content="['CCUI', 'Confidential']">
    <div
      style="height: 200px; background: var(--ccui-color-bg-container); border: 1px dashed var(--ccui-color-border); padding: 16px"
    >
      多行水印
    </div>
  </c-watermark>
...
<template>
  <c-watermark content="Important" :font="{ color: 'rgba(255, 0, 0, 0.18)', fontSize: 18, fontWeight: 600 }">
    <div
      style="height: 160px; background: var(--ccui-color-bg-container); border: 1px solid var(--ccui-color-border-secondary); padding: 16px"
    >
      自定义颜色 / 字号 / 粗细
    </div>
  </c-watermark>
...
<template>
  ...
  >
    <div
      style="height: 200px; background: var(--ccui-color-bg-container); border: 1px solid var(--ccui-color-border-secondary); padding: 16px"
    >
      图片水印（背景层）
    </div>
  </c-watermark>
