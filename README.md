...
视觉规范对齐 [Ant Design v6.3.7](https://ant.design)，主题 Token 已按官方默认 Seed/Map Token 实现。当前已交付 **64 个组件 / 工具入口**，详细覆盖度与剩余项见 [`docs-notes/components-diff/references/components-diff.md`](./docs-notes/components-diff/references/components-diff.md)。
...
| 组件                            | 复杂度 | 备注                                    |
| ------------------------------- | ------ | --------------------------------------- |
| TreeSelect                      | 复杂   | 复用 Tree + Select；Cascader 已交付 80% |
